<script lang='ts'>
  ...
  const card2 = $state({
    cardTitle: {
      text: 'Here\'s a new card, it does a thing WING WONG'
    },
    cardBody: {
      text: 'card body new new new content BING BONG'
    },
    cardHeader: {
      text: 'Card header header header LING LONG'
    }
  });
...
<div class="grid">
  ...
  <Card {...card2} />
  <Card
    cardTitle={{ text: 'heyo Card TITLE'}}
    cardHeader={{ text: 'heyo Card HEADER'}}
    cardBody={{ text: 'heyo Card HEADER'}}
  />
